...
first_data['제목'] = properties['제목']['title'][0]['plain_text']
first_data['일차'] = properties['일차']['number']
first_data['단계'] = f"{properties['단계']['select']['name']}단계"
